...
${PASSWORD_ERROR_MESSAGE}    //android.widget.TextView[contains(@text, "Please enter at least 8 characters")]
...
Verify Password Error
    Wait Until Element Is Visible    ${PASSWORD_ERROR_MESSAGE}    timeout=10s
